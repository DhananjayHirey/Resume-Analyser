...
<div class="flex w-full justify-center flex-wrap md:justify-between  md:flex-nowrap" >
    ...
    <script>
        ...
        function apply_filters(){
            ...
            const requestData = `year1=${encodeURIComponent(year1)}&year2=${encodeURIComponent(year2)}&year3=${encodeURIComponent(year3)}&uni=${encodeURIComponent(uni)}&dept=${encodeURIComponent(dept)}`;
